    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras !=null) {
            ...
            if(Value>0){
                ...
                String phon = rs.getString(rs.getColumnIndex(DBHelper.CONTACTS_COLUMN_PRICE));
                String emai = rs.getString(rs.getColumnIndex(DBHelper.CONTACTS_COLUMN_DESCR));
                ...
                price.setText((CharSequence)phon);
                price.setFocusable(false);
                price.setClickable(false);

                descr.setText((CharSequence)emai);
        ...
        if(extras !=null) {
            ...
            if(Value>0){
                if(mydb.updateContact(id_To_Update,name.getText().toString(),
                        price.getText().toString(), descr.getText().toString())){
                ...
                if(mydb.insertContact(name.getText().toString(), price.getText().toString(),
