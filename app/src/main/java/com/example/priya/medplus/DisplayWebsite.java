...
public class DisplayWebsite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wname = (EditText) findViewById(R.id.wname_et);
        ...
        if(extras !=null) {
            ...
            if(Value>0){
                ...
                String wnam = rs.getString(rs.getColumnIndex(DBHelper.CONTACTS_COLUMN_WEB));
                ...
                wname.setText((CharSequence)wnam);
    ...
    public void run(View view) {
        ...
        if(extras !=null) {
            int Value = extras.getInt("shopid");
            if(Value>0){
                if(mydb.updateContactShop(id_To_Update,wname.getText().toString())){
                ...
                if(mydb.insertShop(wname.getText().toString())){
